 ...
 */
#define SET_LOWER_START_ADDRESS(addr) (0x00 + addr)
/**
 ...
 * Table 9-1 and Section 10.1.3 for details.
 */
#define SET_HIGHER_START_ADDRESS(addr) (0x10 + addr)
/**
 ...
 */
#define SET_MEMORY_ADDRESSING_MODE_PAGE 0x10
/**
 ...
 */
#define SET_MEMORY_ADDRESSING_MODE_HORIZONTAL 0x00
/**
 ...
 */
#define SET_MEMORY_ADDRESSING_MODE_VERTICAL 0x01
/**
 ...
 */
#define SET_DISPLAY_START_LINE(value) (0x40 + value)
/**
 ...
 */
#define SET_SEGMENT_REMAP(mode) (0xA0 + mode)
/**
 ...
 */
#define SET_ENTIRE_DISPLAY_ON(force) (0xA4 + force)
/**
 ...
 */
#define SET_NORMAL_INVERSE_DISPLAY(inverse) (0xA6 + inverse)
/**
 ...
 * o AFh : Display ON
 */
#define SET_DISPLAY_ON_OFF(on) (0xAE + on)
/**
 ...
 */
#define SET_PAGE_START_ADDRESS(addr) (0xB0 + addr)
/**
 ...
 */
#define SET_COM_OUTPUT_SCAN_DIRECTION(dir) (0xC0 + dir)
/**
